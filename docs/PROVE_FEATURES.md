...
| Reports hub (012)   | `/reports`                  | catalog tab; Run reports tab; Recent activity     | 4 report processes listed; CSV/XLS/HTML actions; activity log                                                                | **pass** 2026-08-04 — 3 tabs; catalog table + run cards (signed-out shell; API needs sign-in)                                                                        |
