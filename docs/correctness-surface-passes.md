...
| P1 | `alerts-page` | yes spec | `alerts.test.ts` | **pass** 2026-08-08 — Act→Accept+note committed; History shows accepted timeline; hosted Refresh | Explain letter-prose cleanup deferred | 2026-08-08 |
...
- Sources geocode label quality → calm miss OK; manual lat/lng works.
- Practice CSV re-import on demo tenant → Dynamo duplicate keys (expected guard).
- Reports printable blob tab → automation may redirect; API path verified.
